                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="form-input form">
                                                    <x-form.input name='addr[billing][post_code]' type="text"
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="select-items">
                                                    <x-form.select name='addr[billing][stata]' placeholder="stata" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 form-input form">
                                                        <x-form.input name='addr[shipping][first_name]' value="dd"
                                                           type="text"
                                                            placeholder="First Name" />
                                                    </div>
                                                    <div class="col-md-6 form-input form">
                                                        <x-form.input name='addr[shipping][last_name]' type="text" value="dd"
                                                            placeholder="Last Name" />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>Email Address</label>
                                                <div class="form-input form">
                                                    <x-form.input name='addr[shipping][email]' type="text" value="dd"
                                                        placeholder="Email Address" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>Phone Number</label>
                                                <div class="form-input form">
                                                    <x-form.input name='addr[shipping][phone_number]' type="text" value="dd"
                                                        placeholder="Phone Number" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                <label>Mailing Address</label>
                                                <div class="form-input form">
                                                    <x-form.input name='addr[shipping][street_address]' type="text" value="dd"
                                                        placeholder="Mailing Address" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>City</label>
                                                <div class="form-input form">
                                                    <x-form.input name='addr[shipping][city]' type="text" value="dd"
                                                        placeholder="City" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>Post Code</label>
                                                <div class="form-input form">
                                                    <x-form.input name='addr[shipping][post_code]' type="text" value="dd"
                                                        placeholder="Post Code" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>Region/State</label>
                                                <div class="select-items">
                                                    {{-- <x-form.select name='addr[shipping][stata]' placeholder="stata" :options="$countries" /> --}}
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>Country</label>
                                                <div class="form-input form">
                                                    {{-- <x-form.select name='addr[shipping][country]' placeholder='Stata' /> --}}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
